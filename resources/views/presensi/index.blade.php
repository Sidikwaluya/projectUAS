        ...
        @foreach ($data as $item)
            <tr>
                ...
                <td>
                    ...
                    <a class="btn bi-pencil-square" style="background-color:burlywood; color:antiquewhite" href="{{ url('/presensi/'.$item->nim_mhs.'/edit') }}"> Edit</a>

                    <form onsubmit="return confirm('Yakin mau hapus data?')" class="d-inline" action="{{ '/presensi/'.$item->nim_mhs }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button class="btn bi-trash-fill" style="background-color: brown; color:antiquewhite" type="submit"> Delete</button>
                    </form>
                </td>
            </tr>
        @endforeach
