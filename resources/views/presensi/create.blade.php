...
<div class="container-fluid py-4">
    <a href="/presensi" class="btn bi-skip-backward-fill" style="background-color: burlywood">  Kembali</a>
    <form method="post" action="/presensi" enctype="multipart/form-data">
        ...
        <button class='btn bi-save-fill' type="submit" href='' style="background-color: burlywood">  Simpan</button>
    </form>
    {{-- Sampe --}}
    <div class="row my-4">
